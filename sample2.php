...
<nav class="w3-sidenav nav-sidebar   w3-center w3-padding-24 "  style="width:12%;background-color:#f5f5f5;">
  ...
  <h5>SELECT SEMESTER:</h5>
          ...
          <li class="active"><a href="sample2.php">Second Semester</a></li>
...
<th >STUDENTNAME</th><th >USN</th><th colspan="4">ENGINEERING MECHANICS</th><th colspan="4">ELEMENTS OF ENGINEERING DRAWING</th><th colspan="4">ENGINEERING MATHMATICS</th><th colspan="4">ENGINEERING CHEMISTRY</th><th colspan="4">CO LAB</th><th colspan="4">COSTITUTION OF INDIA</th><th colspan="4">ENVIRONMENTAL STUDIES</th><th colspan="4">FUCTIONAL ENGLISH</th>
...
$query = "SELECT * FROM `secondsem_results`";
