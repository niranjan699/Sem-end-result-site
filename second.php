...
<input  class="form-control"  style="max-width:230px;display:inline"  name="CI3"  required="required"   id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  value=""  / ></label></td></tr>
  <tr><th><font color="darkpink">ENGINEERING CHEMISTRY</font></th><td><label>CIE
...
<input  class="form-control"  style="max-width:230px;display:inline"   required="required"   name="CI6" id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  value=""   /></label></td></tr>
  <tr><th><font color="darkpink">ENVIRONMENTAL STUDIES</th><td><label>CIE
<input  class="form-control"  style="max-width:230px;display:inline"   required="required"  id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  value=""   /></label></td></tr>
  <tr><th><font color="darkpink">FUCTIONAL ENGLISH</th><td><label>CIE
