...
<table class="w3-table w3-bordered w3-striped w3-card-8" style="width:78%;margin-left:250px" cellpadding="20">
...
<input TYPE="SUBMIT" id="but"  name="submit" class="buttonsub" id="sub">
  <value="submit"></input><input TYPE="RESET"   id="but" name="reset"
  <value="reset" id ="sub"class="resetbut"></input></div>
  </a>
  </div>  
  </body>            