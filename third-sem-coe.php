...
<div class="row center">
 ...
 <div class="col-md-7" >
  <h3 style=" text-align:center"><font color="brown">ENTER THE MARKS FOR THIRD SEMESTER SUBJECTS</font></h3>
</div>
</div>
<hr/> 
<div class="row">
...
<input  class="form-control"  style="max-width:230px;display:inline"  required="required"    name="CI2"  min="0" max="50" type="number" placeholder="CIE"  
  ...
  <tr><th><font color="darkpink">WEB PROGRAMMING</font></th><td>
<input  class="form-control"  style="max-width:230px;display:inline"  name="CI3"  required="required"    min="0" max="50" type="number" placeholder="CIE"  
  ...
  value=""  / ></td></tr>
  <tr><th><font color="darkpink">PROGRAMMING WITH C++</font></th><td>
<input  class="form-control"  style="max-width:230px;display:inline"  required="required"   name="CI4"    min="0" max="50" type="number" placeholder="CIE"  
  value=""   /> </label></td><td><input  class="form-control"  required="required"  style="max-width:230px;display:inline" min="0" max="100" type="number" placeholder="SEE"   name="SI4"
  value=""   /></td></tr>
 <tr><th><font color="darkpink">COMPUTER ORGANISATION AND ARCHITECTURE</font></th><td>
