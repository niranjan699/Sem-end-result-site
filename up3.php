...
echo "<form method=\"POST\" action=\"update3.php\" class=\"form w3-center\" id=\"stud\" onsubmit=\"return closeSelf()\">";
...
echo "<table class=\"table table-hover\" style=\"width:70%;margin-left:200px;cellpadding=10\">\n"; 
echo "<tr><th><font color=\"darkpink\">DISCRETE MATHEMATICS</font></th><td>\n"; 
echo "<label>CIE\n"; 
...
echo "  </tr>\n"; 
echo "<tr><th ><font color=\"darkpink\">DATASTRUCTURE</font></th>\n"; 
echo "<td><label>CIE\n"; 
...
echo "  </tr>\n"; 
echo "  <tr><th><font color=\"darkpink\"> WEB PROGRAMMING</font></th><td><label>CIE\n"; 
...
echo "  </tr><tr><th><font color=\"darkpink\">PROGRAMMING WITH C++</font></th><td><label>CIE\n"; 
...
echo "  </tr><tr><th><font color=\"darkpink\">COMPUTER ORGANISATION AND ARCHITECTURE</font></th><td><label>CIE\n"; 
