...
<input  class="form-control"  style="max-width:230px;display:inline"  required="required"    name="CI2" id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  <tr><th><font color="darkpink">ELEMENTS OF MECHANICAL ENGINEERING</font></th><td><label>CIE
<input  class="form-control"  style="max-width:230px;display:inline"  name="CI3"  required="required"   id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  value=""  / ></label></td></tr>
  <tr><th><font color="darkpink">CONCEPTS OF C PROGRAMMING</font></th><td><label>CIE
<input  class="form-control"  style="max-width:230px;display:inline"  required="required"   name="CI4"   id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  ...
  value=""   /></label></td></tr>
 <tr><th><font color="darkpink">CO LAB</font></th><td><label>CIE
...
<input  class="form-control"  style="max-width:230px;display:inline"   required="required"   name="CI6" id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  value=""   /> </label></td><td><label>SEE <input  class="form-control"  required="required"  style="max-width:230px;display:inline"  min="0" max="100" type="number" id="s2" onblur="marksval('s2')" name="SI6"
  value=""   /></label></td></tr>
  <tr><th><font color="darkpink">PERSONALITYDEVELOPMENT AND COMMUNICATION</th><td><label>CIE
<input  class="form-control"  style="max-width:230px;display:inline"   required="required"  id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  value=""   /> </label></td><td><label>SEE <input  class="form-control"  required="required"  style="max-width:230px;display:inline"  min="0" max="100" type="number" id="s2" onblur="marksval('s2')" name="SI7"
  value=""   /></label></td></tr>
  <tr><th><font color="darkpink">ENGINEERING MATHEMATICS</th><td><label>CIE
<input  class="form-control"  style="max-width:230px;display:inline"   required="required"  name="CI8" id="ci" min="0" max="50" type="number"  onblur="marksval('ci')"
  value=""   /> </label></td><td><label>SEE <input   class="form-control"  required="required"  style="max-width:230px;display:inline"  min="0" max="100" type="number" id="s2" onblur="marksval('s2')"name="SI8"
  ...
  <div class="modal-dialog">
    ...
    <div class="row"><hr/></div>
      ...
      <div class="modal-body center">
         <form method="post" action="upload1.php" onSubmit="alert('uploadsucessfull')";enctype="multipart/form-data"/>
  <div class="row">
  <div class="col-md-1"></div>
    <div class="col-md-10"><input type="file" style="display:inline;" class="form-control"  name="file"></div>
  </div>
  <br/>
<div class="row">
